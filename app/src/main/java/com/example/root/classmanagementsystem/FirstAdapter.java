...
public class FirstAdapter extends RecyclerView.Adapter<FirstAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position){
        ...
        holder.getmDate().setText(String.valueOf(mCursor.getLong(Utility.COL_CLASS_INFO_DATE)));
        ...
        holder.getmSubject3().setText(mCursor.getString(Utility.COL_CLASS_INFO_TEACHER_3));
